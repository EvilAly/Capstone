<aside id="sidebar">
    <div>
        ...
        <a href="index.php?action=" data-action="breakfast">Breakfast</a><br>
        <a href="index.php?action=" data-action="appetizer">Appetizer</a><br>
        <a href="index.php?action=" data-action="dinner">Dinner</a><br>
        <a href="index.php?action=" data-action="dessert">Dessert</a><br>
        <a href="index.php?action=" data-action="all">All Recipes</a><br>
    ...
    <div>
        ...
        if (!isset($_SESSION['user'])) {
            include '../includes/logIn_other.php';
        } else {
            echo '<a href="../user_manager/index.php?action=list">Shopping List</a><br>';
            echo '<a href="../user_manager/index.php?action=saved">Saved Recipes</a><br>';
            echo '<a href="../user_manager/index.php?action=logout">Log Out</a><br>';
